...
def select_map_size():
    print("Выберите размер игрового поля:")
    print("1 - Стандартный (20x10)")
    print("2 - Большой (30x15)")
    print("3 - Маленький (15x8)")
    while True:
        choice = input("Ваш выбор (1-3): ")
        if choice in MAP_SIZES:
            return MAP_SIZES[choice]
        print("Некорректный ввод. Попробуйте снова.")

MAP_WIDTH, MAP_HEIGHT = select_map_size()
TICK_INTERVAL = 0.2
TREE_FREQUENCY = 50
